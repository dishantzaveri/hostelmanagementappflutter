...
import 'package:easydorm/student_files/food_class.dart';
import 'package:easydorm/student_files/food_def.dart';
...
class _FoodState extends State<Food> {
  ...
  Widget buildpay(Myfood user) => Column(
