...
class _ReachUsState extends State<ReachUs> {
  ...
  _launchURLMail() async {
    const url =
        'mailto:zaveridishant@gmail.com?subject=LifePlusApp&body=Your sugestions%20or Feedback..';
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      throw 'Could not launch $url';
        ...
        child: Column(
          ...
          children: <Widget>[
              ...
              child: GestureDetector(
                onTap: () {
                  setState(() {
                    ...
                    t2.clear();
                    launchUrl(
                        "mailto:zaveridishant@gmail.com?subject=From $name&body=$message");
                  });
                },
                child: ListTile(
                  title: Row(
            ...
            Padding(
              ...
              child: Text(
                "Please report any discrepancies in your records .",
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontFamily: 'RobotoSlab',
                  color: Colors.white,
            ...
            Row(
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: () => launchUrl(
                      "https://github.com/dishantzaveri/hostelmanagementappflutter"),
                  child: Icon(
